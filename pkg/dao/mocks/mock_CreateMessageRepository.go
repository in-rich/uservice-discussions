...
import (
	...
	dao "github.com/in-rich/uservice-discussions/pkg/dao"
...
// CreateMessage provides a mock function with given fields: ctx, authorID, teamID, in
func (_m *MockCreateMessageRepository) CreateMessage(ctx context.Context, authorID string, teamID string, in *dao.CreateMessageData) (*entities.Message, error) {
	ret := _m.Called(ctx, authorID, teamID, in)
...
//   - authorID string
//   - teamID string
//   - in *dao.CreateMessageData
func (_e *MockCreateMessageRepository_Expecter) CreateMessage(ctx interface{}, authorID interface{}, teamID interface{}, in interface{}) *MockCreateMessageRepository_CreateMessage_Call {
	return &MockCreateMessageRepository_CreateMessage_Call{Call: _e.mock.On("CreateMessage", ctx, authorID, teamID, in)}
}

func (_c *MockCreateMessageRepository_CreateMessage_Call) Run(run func(ctx context.Context, authorID string, teamID string, in *dao.CreateMessageData)) *MockCreateMessageRepository_CreateMessage_Call {
